...
(3, 1000000.00, 'Inactive'); -- Test Case 2: Nhiều tiền nhưng thẻ bị khóaCREATE DATABASE RikkeiClinicDB;
USE RikkeiClinicDB;
...
set @message1 = '';
call issue_medicine(1, 1, 2, @message1);
select @message1 as result_status;
select * from medicines where medicine_id = 1;
select * from patient_invoices where patient_id = 1;

set @message2 = '';
call issue_medicine(2, 2, 10, @message2);
select @message2 as result_status;
