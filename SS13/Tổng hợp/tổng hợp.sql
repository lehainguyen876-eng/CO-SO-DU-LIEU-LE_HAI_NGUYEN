...
begin
    ...
    elseif v_balance < v_price then
        ...
        update wallets set balance = balance - v_price where patient_id = new.patient_id;
    end if;
end //
delimiter ;
...
select * from service_usages where patient_id = 1;

insert into service_usages (patient_id, service_id) values (3, 1);

insert into service_usages (patient_id, service_id) values (2, 1);delete from service_usages;
update wallets set balance = 500000 where patient_id = 1;